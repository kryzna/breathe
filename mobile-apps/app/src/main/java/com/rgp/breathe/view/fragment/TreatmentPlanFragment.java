...
public class TreatmentPlanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expandableListView = (ExpandableListView) rootView
                .findViewById(R.id.nav_treatment_plan_2_expandable_list);
    ...
    private void prepareListData() {
        ...
        List<String[]> ldata2 = new ArrayList<String[]>(4);
        ldata2.add(data1);
        ldata2.add(data2);
        ldata2.add(data3);
        ldata2.add(data4);
