...
public class LeftMenu {
    public WebElement userName, userEmail, leftnav, leftnav_Healthassessment,
            leftnav_Healthassessment_btn, leftNavTracking;
    ...
    public void setLeftNavTracking(AndroidDriver aDriver) {
        leftNavTracking = aDriver.findElement(By.xpath(
                "//android.widget.FrameLayout[@resource-id='com.rgp.breathe:id/nav_view']/android.support.v7.widget.RecyclerView//android.widget.CheckedTextView[contains(@text,'Tracking')]"));
    }
