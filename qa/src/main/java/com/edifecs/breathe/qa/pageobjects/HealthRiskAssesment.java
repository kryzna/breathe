...
public class HealthRiskAssesment {
    ...
    public WebElement leftnav_Healthassessment, leftnav_Healthassessment_btn,
            leftnav_Healthassessment_choice_yes, getHealtAssessment_questionnairechoice_yes_radio1,
            getHealtAssessment_questionnairechoice_next,
    ...
    public void getHealtAssessment_questionnairechoice_next(AndroidDriver aDriver) {
        getHealtAssessment_questionnairechoice_next =
                aDriver.findElement(By.id("android:id/button1"));
