...
public class Tracking {
    ...
    public void setTrackingElements(AndroidDriver aDriver) {
        trackingElements = aDriver.findElements(By.xpath(
                "//android.support.v7.widget.RecyclerView[@resource-id='com.rgp.breathe:id/tracking_recyclerView']/android.widget.LinearLayout"));
        ...
        if (trackingElements.size() > 0) {
            for (int i = 1; i <= trackingElements.size(); i++) {
                trackingDateTime = aDriver.findElement(By
                        .xpath("//android.support.v7.widget.RecyclerView[@resource-id='com.rgp.breathe:id/tracking_recyclerView']/android.widget.LinearLayout["
                                + i
                                + "]/android.widget.LinearLayout[1]/android.widget.TextView[3]"));
                trackingRowsDateTime.add(trackingDateTime);
                trackingPeakValue = aDriver.findElement(By
                        .xpath("//android.support.v7.widget.RecyclerView[@resource-id='com.rgp.breathe:id/tracking_recyclerView']/android.widget.LinearLayout["
                                + i
    ...
    public void setNumberPicker(AndroidDriver aDriver) {
        numberPicker = aDriver
                .findElement(By.xpath("//android.widget.NumberPicker[1]/android.widget.Button[1]"));
    }
