...
public static String appiumInstallationDir = "E:/Program Files (x86)";
    public static String appiumNode = appiumInstallationDir + File.separator + "Appium" + File.separator + "node.exe";
    public static String appiumNodeModule = appiumInstallationDir + File.separator + "Appium" + File.separator + "node_modules"
